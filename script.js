...
const openModalSingUp = function (e) {
  e.preventDefault();
  modalSingUp.classList.remove('hidden');
  overlay.classList.remove('hidden');
};
// --------- MODAL LOGIN IS NOT WORKING!!!!!!!!!!!
// --------- MODAL LOGIN IS NOT WORKING!!!!!!!!!!!
// --------- MODAL LOGIN IS NOT WORKING!!!!!!!!!!!
// --------- MODAL LOGIN IS NOT WORKING!!!!!!!!!!!
// --------- MODAL LOGIN IS NOT WORKING!!!!!!!!!!!
const closeModal = function () {
  modalSingUp.classList.add('hidden');
...
btnsOpenModalSingUp.addEventListener('click', openModalSingUp);
...
document.addEventListener('keydown', function (e) {
  if (
    (e.key === 'Escape' && !modalSingUp.classList.contains('hidden')) ||
...
///// CHANGE MODALS!!!!! NOT WORKING:
loginToChange.addEventListener('click', function (e) {
  e.preventDefault();
  modalSingUp.classList.remove('hidden');
});
